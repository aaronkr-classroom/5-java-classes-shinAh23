...
public class Animal {
	    ...
	    public void setAge(int age) { this.age = age;} // this.age?
	    ...
	    // 메세드 오버로딩 (같은 객체에서 다른 매개변수 주기)
	    public void myRole(int age, String name) {
	    	System.out.println(name + "은 고양이 집사입니다. 나이는"+ age +"입니다");
	    }
	    
	    public void sound() { // 메서드 오버라이팅 (다른 객체에서 덮어쓰기)
